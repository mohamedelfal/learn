...
function initGraphics() {
    ...
    TweenLite.set('.hand--left', {
        svgOrigin: '380 370'
    });
    TweenLite.set('.eyebrow--left', {
        svgOrigin: '442 262'
    });
    TweenLite.set('.eyebrow--right', {
        svgOrigin: '515 250'
    });
}
...
function animateAvatar(rate, dur) {
    ...
    TweenLite.to('.eyebrow--second', dur, {
    ...
    if (rate === 1) {
        TweenLite.to([eyebrowLeft, eyebrowRight], dur, {
            scale: 1,
            rotation: 1,
            opacity: 0.7
        });
    } else if (rate === 2) {
        TweenLite.to(eyebrowLeft, dur, {
            scale: 0.7,
            rotation: 40,
            opacity: 1
        });
        TweenLite.to(eyebrowRight, dur, {
            scale: 0.75,
            rotation: -50,
            opacity: 1
        });
